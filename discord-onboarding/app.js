...
function playClickSound(volumeMultiplier = 1.0) {
    try {
        ...
        snapGain.gain.setValueAtTime(0.003 * volumeMultiplier, time); 
        ...
        bodyGain.gain.setValueAtTime(0.004 * volumeMultiplier, time); 
...
function nextStep(current, next) {
    if (current === 1) {
        playClickSound(0.03); // Make the first button click sound 97% quieter!
    } else {
        playClickSound(1.0);
    }
